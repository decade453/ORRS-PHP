...
<!--
	...
	// COLLEGE OF INFORMATION TECHNOLOGY | Developed by: John Jabez Capistrano
-->
<html>
	<head>
					...
					<section id="footer">
						<div class="inner">
							...
							<ul class="contact">
								...
								<li class="icon solid fa-phone">(054)256-6159</li>
							...
							<ul class="copyright">
								<li>&copy; Online Railway Reservation System.</li><li>Developed By: John Jabez Capistrano</li>
							</ul>
						</div>
					</section>
